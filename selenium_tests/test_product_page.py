...
def test_product_page(browser):
    ...
    wait.until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, "input[name='product_id'] ~ button")))
    ...
    browser.find_element(By.CSS_SELECTOR, ".btn-group > button[data-original-title='Add to Wish List']")
